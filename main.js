...
function intro() {
  ...
  const seq = [
    ...
    [850, () => stage.classList.add("s-domain")],   // "neelbansal" types up in black with caret
    [1550, () => stage.classList.add("s-sub")],     // ".dev" slides out after it in light blue, blur → sharp
